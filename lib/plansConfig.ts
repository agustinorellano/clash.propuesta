...
export const PLANS_STATIC: PlanStaticConfig[] = [
  ...
  },
  {
    ...
    pricing: {
      s1: { price: '$380.000', note: '/ mes + IVA · hasta 15 sucursales',  cta: 'Consultar propuesta' },
      s2: { price: '$520.000', note: '/ mes + IVA · hasta 50 sucursales',  cta: 'Consultar propuesta' },
      s3: { price: '$790.000', note: '/ mes + IVA · hasta 100 sucursales', cta: 'Consultar propuesta' },
  ...
  },
  {
    ...
    pricing: {
      s1: { price: '$590.000',   note: '/ mes + IVA · hasta 15 sucursales',  cta: 'Coordinar demo' },
      s2: { price: '$1.250.000', note: '/ mes + IVA · hasta 50 sucursales',  cta: 'Coordinar demo' },
      s3: { price: '$2.100.000', note: '/ mes + IVA · hasta 100 sucursales', cta: 'Coordinar demo' },
